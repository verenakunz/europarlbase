...
#'
#' `get_mep_political()` gets the political MEP data from EuroParlBase.
#' @export

get_mep_political <- function(access_token = NULL) {
  ...
  url <- paste0("https://dataverse.harvard.edu/api/access/datafile/10676738?key=", access_token)
